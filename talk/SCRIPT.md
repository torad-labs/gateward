...
Before I tell you what this talk is, let me show you why it exists. This is a
real file an agent produced.
...
If you came hoping I'll tell you AI is magic, you're in the wrong room. And if
you're certain AI code is garbage, you're going to enjoy the next half hour,
because I'm going to agree with you. And then we're going to do something
about it.

**[Slide 5 · the short version]**

Now that you've seen it: here's the short version, so you can decide how hard
to listen. Agents are about to write most of our code. The way we enforce
standards today, documents and review, doesn't survive that. What does survive
is running our rules at the exact moment the code gets written. That's the
entire talk. It's practical, and there will be YAML.
...
Part two. I'll show you the whole thing working first, in one command, and
then we'll take it apart.

**[Slide 19 · the whole idea, in one command]**

Before I explain a single line, here's the whole idea working. This is one
command in the repo. No agent, no network. It runs the shipped code.

A violating write is blocked, with instructions. An old finding is tolerated,
but a new one is stopped. The move-it-in-with-mv side door is caught. A stop
with open work is blocked. And the same rule fires the same way through two
different harness protocols, a Claude write and a Codex patch. Everything I'm
about to explain is behind this one command, and so is every number in this
talk. Now let's take it apart.

**[Slide 20 · what a lifecycle hook is]**
...
**[Slide 26 · step five, the block message]**
...
**[Slide 27 · the payoff, real capture]**
...
**[Slide 32 · the side door, a true story]**
...
**[Slide 34 · design decision three, numbers]**
...
**[Slide 43 · running in production]**
...
whole time, no new violation in these packs has reached the codebase.

---

## Close — 30:30

**[Slide 44 · three ideas, again]**

The same three ideas, so they leave the room with you. Agents don't read
your docs. Gates, not guidelines. Tenets that travel.

**[Slide 45 · what this does to seniority]**
...
write reviews every future attempt, and it keeps working after you've stopped
paying attention. Encoding your taste as rules is senior work, not less of it.

**[Slide 46 · the homework]**
...
review. Watch it self-correct once, then decide whether it belongs in your
workflow.
...
The repo's live. Scan it, take one rule, try it before your next PR.

(Pause.)

A prompt is a suggestion. A gate is a rule.

(Stop. Say nothing after it. Take questions once the applause settles.)
